<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="EditarOcorrencia.aspx.cs" Inherits="_webCamadaUI.Procurase.EditarOcorrencia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="row row-centered" id="tudo">
            ...
            <asp:TextBox ID="txtID_ENDERECO" runat="server" Visible="false" />
			<asp:TextBox ID="txtID_OCORRENCIA" runat="server" Visible="false" />
            ...
            <div style="float: left;">
                ...
                <div>
                    Logradouro:<br />
                    <asp:TextBox ID="txtLogradouro" runat="server" placeholder="Telefone" Width="45%" name="logradouro" />
                    <asp:RequiredFieldValidator SetFocusOnError="true" ValidationGroup="editar-campos-principais"
                ...
                <div>
                    Numero:<br />
                    <asp:TextBox ID="txtNumero" runat="server" placeholder="Telefone" Width="45%" />
                    <asp:RequiredFieldValidator SetFocusOnError="true" ValidationGroup="editar-campos-principais"
                ...
                <div>
                    Bairro:<br />
                    <asp:TextBox ID="txtBairro" runat="server" placeholder="Telefone" Width="45%" />
                    <asp:RequiredFieldValidator SetFocusOnError="true" ValidationGroup="editar-campos-principais"
                ...
                <div>
                    Ocorrência:<br />
                    <asp:CheckBox ID="chbAtivo" runat="server" Text="Ativo"/>
                    <br />
                </div>
            </div>
        </div>
        <asp:Button ID="btnCadastrar" runat="server" CssClass="btn btn-success" Text="Cadastrar" OnClick="CadastrarOcorrencia" ValidationGroup="editar-campos-principais" />
        <input type="button" class="btn btn-primary" onclick="javascript: location.href = 'ConsultarOcorrencias.aspx';" value="Voltar" />
        <br />
        <p>
